...
def main():
    ...
    for model in ["sparta"]:
        for dataset in ["irds:beir/arguana", "irds:beir/scifact/test", "irds:beir/nfcorpus/test"]: # ["irds:beir/cqadupstack/android", "irds:beir/cqadupstack/english", "irds:beir/cqadupstack/gaming", "irds:beir/cqadupstack/gis", "irds:beir/cqadupstack/mathematica", "irds:beir/cqadupstack/physics", "irds:beir/cqadupstack/programmers", "irds:beir/cqadupstack/stats", "irds:beir/cqadupstack/tex", "irds:beir/cqadupstack/unix", "irds:beir/cqadupstack/webmasters", "irds:beir/cqadupstack/wordpress"]:
